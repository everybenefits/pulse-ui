...
import type { AlertKind, ConfirmState, ToastItem } from "./alert-provider";
      ...
      >
        ...
        <div className="mt-5 flex justify-end gap-2">
          <Button variant="ghost" onClick={onCancel}>
            {confirm.cancelLabel ?? labels.cancel}
          </Button>
          <Button
            ref={confirmRef}
            ...
            onClick={onConfirm}
          >
            {confirm.confirmLabel ?? labels.confirm}
          </Button>
        </div>
      </motion.div>
    </motion.div>
